...
class MainViewController: UIViewController {
    ...
    private var studentsTableViewController: StudentsTableTableViewController! {
        didSet {
            updateDataSource()
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        studentsTableViewController = (segue.destination as! StudentsTableTableViewController)
    }
